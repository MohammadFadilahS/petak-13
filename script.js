...
const option_listdivnthlastchild = document.querySelector (".option_list div:nth-last-child(2)");
...
const option_listdivnthlastchild2= document.querySelector(".option_list div:nth-last-child(3)");
